class StringsAlign {
    ...
    horizontal(
        ...
        if (axisX_index_int >= strings.length - 1)
            axisX_index_int = strings.length - 1;
        ...
        if (!pg) {
            ...
            for (let i = 0; i < strings.length; i++) {
                ...
                if (reAxisX) {
                    ...
                    pos_x =
                        index_x -
                        distance * axisX_index_int +
                        distanceMax * axisX_index_int;
                }
    ...
    vertical(
        ...
        if (axisY_index_int >= strings.length - 1)
            axisY_index_int = strings.length - 1;
        ...
        if (!pg) {
            ...
            for (let i = 0; i < strings.length; i++) {
                ...
                if (reAxisX) {
                    ...
                    pos_y =
                        index_y -
                        distance * axisY_index_int +
                        distanceMax * axisY_index_int;
                }
